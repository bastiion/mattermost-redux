...
export function  generateMassInvitationToTeam(teamId: string, to: string, amount: number, mailPrefix: string, mailSuffix: string): ActionFunc {
    return bindClientFunc({
       clientFunc: Client4.generateMassInvitationToTeam,
       params: [
           teamId,
           to,
           amount,
